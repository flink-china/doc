...
See [Deployment & Operations - Deployment - AWS - S3: Simple Storage Service](../../ops/deployment/aws.html) for available S3 file system implementations, their configuration and required libraries.
...
[Read more about Hadoop compatibility in Flink](../../dev/batch/hadoop_compatibility.html).
